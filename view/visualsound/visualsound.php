<?php /* template visualsound::visualsound v1.05 */
   ...
   if ($param_mode == "playtrack" || $param_mode == "playset" || $param_mode == "playgroup") {
     if ($options['no_caca'] == "true" && (!is_single() && !is_page())) { $autostart = "false"; } else { $autostart = "true"; }
...
<?php } elseif ($param_mode == "visualmix" || $param_mode == "visualdreams") { ?>
<div style="height: <?php echo $options['iheight']?>px; width: 100%;" class="iframe-wrapper">
...
<!-- visual-sound plug-in player start -->
<object height="100%" width="<?php echo $options['appletwidth']?>">  
<param name="movie" value="http://player.soundcloud.com/player.swf?group=<?php echo $param_user ?>&amp;show_comments=<?php echo $options['appletcomments'] ?>&amp;auto_play=<?php echo $autostart?>&amp;color=<?php echo $options['appletcolor']?>&amp;theme_color=<?php echo $options['themecolor']?>&amp;comments_color=<?php echo $options['commentscolor']?>"></param>  
<param name="allowscriptaccess" value="always"></param>  
<param name="wmode" value="transparent"></param>  
<embed allowscriptaccess="always" height="100%" src="http://player.soundcloud.com/player.swf?group=<?php echo $param_user ?>&amp;show_comments=<?php echo $options['appletcomments']?>&amp;auto_play=<?php echo $autostart?>&amp;color=<?php echo $options['appletcolor']?>&amp;theme_color=<?php echo $options['themecolor']?>&amp;comments_color=<?php echo $options['commentscolor']?>" type="application/x-shockwave-flash" width="<?php echo $options['appletwidth']?>" wmode="transparent"> </embed> 
</object><br clear="all">
<span title="<?php echo $visualsound_by?>">Group:</span> <a href="http://soundcloud.com/groups/<?php echo $param_user?>" title="Group <?php echo $param_user ?>"><?php echo $param_user?></a> <?php echo $visualattribution ?>
<!-- visual-sound plug-in player stop -->
